import 'package:app/novel/widgets/episode_list.dart';
import 'package:app/novel/widgets/novel_introduction.dart';
import 'package:app/novel/widgets/novel_notice.dart';
      ...
      child: SizedBox(
        ...
        child: Stack(
          ...
          NestedScrollView(
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                //흐릿한 썸네일을 배경으로 깐다
                                image: AssetImage(TmpNovelModel.novelList[0].thumbnail),
                                fit: BoxFit.cover,
                              )),
                          child: Column(
                            children: [
                                      ...
                                      child: Column(
                                        children: <Widget>[
                                          ...
                                          Container(
                                            ...
                                            height: 300,
                                            child: Image.asset(
                                                TmpNovelModel.novelList[0].thumbnail),
                                          ),
                                          //소설 제목
                                          Container(
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Text(
                                                TmpNovelModel.novelList[0].category,
                                                style: const TextStyle(
                                              ...
                                              Text(
                                                TmpNovelModel.novelList[0].writer,
                                                style: const TextStyle(
                                                  color: Colors.white60,
                                                  fontWeight: FontWeight.bold,
                                                ),
            ...
            controller: _controller,
            children: [
              EpisodeList(thumbnail: TmpNovelModel.novelList[0].thumbnail,),
              NovelIntroduction(introduction: TmpNovelModel.novelList[0].introduction),
              const NovelNotice()
            ],
          ),
          ),
