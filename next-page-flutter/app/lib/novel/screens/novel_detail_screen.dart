              ...
              NestedScrollView(
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                    //흐릿한 썸네일을 배경으로 깐다
                                    image: AssetImage(
                                        TmpNovelModel.novelList[widget.id-1].thumbnail),
                                    fit: BoxFit.cover,
                                  )),
                              child: Column(
                                children: [
                                            ...
                                            children: <Widget>[
                                              ...
                                              Container(
                                                padding: const EdgeInsets.fromLTRB(
                                                    0, 45, 0, 10),
                                                height: 300,
                                                child: Image.asset(TmpNovelModel
                                                    .novelList[widget.id-1].thumbnail),
                                              ),
                                              //소설 제목
                                              Container(
                                                padding: const EdgeInsets.all(7),
                                                child: Text(
                                                  TmpNovelModel.novelList[widget.id-1].title,
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  Text(
                                                    TmpNovelModel
                                                        .novelList[widget.id-1].category,
                                                    style: const TextStyle(
                ...
                body: TabBarView(
                  ...
                  children: [
                    EpisodeList(
                      id: widget.id,
                      thumbnail: TmpNovelModel.novelList[widget.id-1].thumbnail,
                    ),
                    NovelIntroduction(
                        introduction: TmpNovelModel.novelList[0].introduction),
                    const NovelNotice()
                  ],
                ),
              ),
